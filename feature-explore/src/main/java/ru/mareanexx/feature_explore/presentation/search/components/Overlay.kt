...
import ru.mareanexx.common.ui.theme.searchText
            ...
            Row(
                ...
                Button(
                    ...
                    Icon(
                        ...
                        tint = primaryText,
                        contentDescription = stringResource(ru.mareanexx.core.common.R.string.close)
                    )
                }
            }
            TextButton(onClick = onClose, contentPadding = PaddingValues(horizontal = 0.dp)) {
                Text(
                    text = stringResource(ru.mareanexx.core.common.R.string.close),
