package ru.mareanexx.travelogue.presentation.screens.othersprofile
...
import ru.mareanexx.travelogue.presentation.screens.othersprofile.viewmodel.OthersProfileViewModel
    ...
    when(uiState.value) {
        OthersProfileUiState.Error -> {
            Box(modifier = Modifier
                ...
                ErrorLoadingContent(
                    message = R.string.error_loading_others_profile,
