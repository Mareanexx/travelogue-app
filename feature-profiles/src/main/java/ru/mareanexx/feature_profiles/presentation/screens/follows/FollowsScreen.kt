package ru.mareanexx.feature_profiles.presentation.screens.follows
...
import ru.mareanexx.feature_profiles.presentation.screens.follows.components.FollowsErrorRetry
import ru.mareanexx.feature_profiles.presentation.screens.follows.components.FollowsHeader
import ru.mareanexx.feature_profiles.presentation.screens.follows.components.FollowsSkeleton
import ru.mareanexx.feature_profiles.presentation.screens.follows.components.OneFollowsCard
import ru.mareanexx.feature_profiles.presentation.screens.follows.viewmodel.FollowsEvent
import ru.mareanexx.feature_profiles.presentation.screens.follows.viewmodel.FollowsUiState
import ru.mareanexx.feature_profiles.presentation.screens.follows.viewmodel.FollowsViewModel
...
fun FollowsScreen(
    ...
    when(uiState.value) {
        ...
        is FollowsUiState.Error -> FollowsErrorRetry(username, navigateBack,
...
fun FollowsLoadedContent(
    ...
    val tabs = listOf(ru.mareanexx.core.common.R.string.followers, ru.mareanexx.core.common.R.string.followings)
