package ru.mareanexx.feature_profiles.presentation.screens.activity
...
import ru.mareanexx.feature_profiles.presentation.screens.activity.components.ActivitySkeleton
import ru.mareanexx.feature_profiles.presentation.screens.activity.components.TripCardBigUsername
import ru.mareanexx.feature_profiles.presentation.screens.activity.viewmodel.ActivityViewModel
...
fun NowOnATripLazyColumn(
    tripsData: List<ActivityTripWithMapPoints>,
    onNavigateToTrip: (tripId: Int, profileId: String, username: String, avatar: String) -> Unit,
    onNavigateToOthersProfile: (Int) -> Unit,
    ...
    LazyColumn {
        item {
            Text(
                ...
                text = stringResource(ru.mareanexx.core.common.R.string.now_on_a_trip).lowercase().replaceFirstChar { it.uppercaseChar() },
