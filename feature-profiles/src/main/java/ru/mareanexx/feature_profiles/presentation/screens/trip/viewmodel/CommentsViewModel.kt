...
import ru.mareanexx.network.data.comments.mapper.toEntity
...
import ru.mareanexx.network.domain.comments.usecase.AddNewCommentUseCase
import ru.mareanexx.network.domain.comments.usecase.GetCommentsUseCase
    ...
    fun addNewComment() {
        viewModelScope.launch {
            ...
            addNewCommentUseCase(
                NewCommentRequest(
                    mapPointId = _mapPointId.value,
                    text = _commentMessage.value,
