...
@Composable
fun FollowsErrorRetry(profileUsername: String, navigateBack: () -> Unit, onRetry: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Row(
            ...
            Icon(
                ...
                contentDescription = stringResource(ru.mareanexx.feature_profiles.R.string.search_follows_cd)
            )
        }
