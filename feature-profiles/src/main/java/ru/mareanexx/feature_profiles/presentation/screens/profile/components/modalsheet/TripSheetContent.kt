...
import ru.mareanexx.common.ui.components.interactive.LeadingIcon
...
import ru.mareanexx.feature_profiles.presentation.screens.profile.components.trips.AddTagButton
import ru.mareanexx.feature_profiles.presentation.screens.profile.components.trips.CalendarBlock
import ru.mareanexx.feature_profiles.presentation.screens.profile.components.trips.ConcreteTag
import ru.mareanexx.feature_profiles.presentation.screens.profile.components.trips.CoverPhotoChooserBox
import ru.mareanexx.feature_profiles.presentation.screens.profile.components.trips.CoverPhotoImage
...
fun TripSheetContent(
    ...
    Column(
        ...
        TripVisibilityChooserComponent(
            visibilityValue = if (tripForm.type == ru.mareanexx.data.trip.type.TripVisibilityType.Private) R.string.trip_visibility_only_me else R.string.trip_visibility_everyone,
